...
namespace common {
namespace internal {
constexpr uint64_t crc_table[256]{
    ...
    0x56ed3e2f9e22447,  0xb6409f5cfa457b28, 0xfb374270a266cc92,
    0x48190ecea1c193fd, 0xfb374270a266cc9,  0xbc9d3899098133a6,
    0x80e781f45de992a1, 0x33c9cd4a5e4ecdce, 0x7463b7a3f5a932fa,
    0xc74dfb1df60e6d95, 0xc96c5795d7870f4,  0xbfb889c75edf2f9b,
    ...
    0x9f8169ba49a54b3,  0xbad65a25a73d0bdc, 0x710d64410c4b16bd,
    0xc22328ff0fec49d2, 0x85895216a40bb6e6, 0x36a71ea8a7ace989,
    0xadda7c5f3c4488e,  0xb9f3eb7bf06317e1, 0xfe5991925b84e8d5,
    ...
    0xfaa59adf89c9c28c, 0xbd0fe036222e3db8, 0xe21ac88218962d7,
    0xc5fa92ec8aff7fb6, 0x76d4de52895820d9, 0x317ea4bb22bfdfed,
    0x8250e80521188082, 0xbe2a516875702185, 0xd041dd676d77eea,
    0x4aae673fdd3081de, 0xf9802b81de97deb1, 0x4fc0b4dd24d2a599,
    0xfceef8632775faf6, 0xbb44828a8c9205c2, 0x86ace348f355aad,
    0x34107759db5dfbaa, 0x873e3be7d8faa4c5, 0xc094410e731d5bf1,
    0x73ba0db070ba049e, 0xb86133d4dbcc19ff, 0xb4f7f6ad86b4690,
...
constexpr uint64_t crc64_impl(const char *p, uint32_t len, uint64_t crc) {
  return (
      len ? crc64_impl(p + 1, len - 1,
                       (crc >> 8) ^ crc_table[(static_cast<uint8_t>(*p) ^ crc)])
          : crc);
}

constexpr uint64_t crc64(const char *data, uint32_t length) {
  return ~crc64_impl(data, length, ~0lu);
}
...
constexpr uint64_t hash(const char *str) {
  return internal::crc64(str, internal::strlen_c(str));
}

} // namespace common

constexpr uint64_t operator"" _h(const char *source, size_t length) {
  return common::internal::crc64(source, static_cast<uint32_t>(length));
}
